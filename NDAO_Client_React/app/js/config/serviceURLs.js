...
if (CONSTANTS.DEV) {
  ...
  _mapServerBaseURL = 'https://ccis.environment.gov.za/map'
    ...
    // _apiBaseURL = 'http://192.168.105.112/ndao/api/odata/'
    // _siteBaseURL = 'http://192.168.105.112/ndao/'
    // _ccrdBaseURL = 'http://192.168.105.112/nccrd/api/odata/'
    // _ccrdSiteBaseURL = 'http://192.168.105.112/nccrd/'
    // _nccisSiteBaseURL = 'http://192.168.105.112/'
    // _ndmcBaseURL = 'http://192.168.105.112/ndmc/api/'
    // _ndmcSiteBaseURL = 'http://192.168.105.112/ndmc/'
    // _vmsBaseURL = 'https://ccis.envionment.gov.za/vms/api/'
    // _ssoBaseURL = 'https://identity.saeon.ac.za/'
    // _metadataServiceURL = 'https://qad.saeoss.org/Institutions/dea-monitoring-and-evaluation/dea-monitoring-and-evaluation/metadata/jsonCreateMetadataAsJson/'
    // _mapServerBaseURL = 'https://ccis.envionment.gov.za/map'
  _apiBaseURL = 'https://ccis.environment.gov.za/ndao/api/odata/'
