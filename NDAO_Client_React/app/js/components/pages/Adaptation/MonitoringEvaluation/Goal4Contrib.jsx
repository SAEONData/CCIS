...
class Goal4Contrib extends React.Component {
  ...
  validate() {
    ...
    let { Q4_2, metaAuthors, metaDocTitle, metaKeywords, metaDocDescr, metaAgreement } = this.state
    ...
    async saveGoal(metaUID) {
      ...
      let {
        goalId, goalStatus, Q4_2, Q4_1, Q4_3, Q4_3_A, Q4_3_B, Q4_3_C, Q4_3_D, Q4_4, Q4_5, Q4_6,
  ...
  async generateMetaData() {
    ...
    let {
      goalId, Q4_2, metaAuthors, metaDocTitle, metaKeywords,
